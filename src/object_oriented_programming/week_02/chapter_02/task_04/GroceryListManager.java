package object_oriented_programming.week_02.chapter_02.task_04;
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (answer == 1) {
                ...
                listManager.addItemWithQuantity(itemName, quantity);
            } else if (answer == 9) {
                System.out.print("Enter item to update: ");
                String itemName = scanner.next();
                System.out.print("Enter new quantity: ");
                int quantity = scanner.nextInt();
                listManager.updateQuantity(itemName, quantity);
            } else if (answer == 10) {
